...
export default {
  data () {
    return {
      auth_google_url: process.env.API_ENDPOINT + '/auth/google',
      auth_github_url: process.env.API_ENDPOINT + '/auth/github',
      auth_twitter_url: process.env.API_ENDPOINT + '/auth/twitter'
    }
  }
}
</script>
